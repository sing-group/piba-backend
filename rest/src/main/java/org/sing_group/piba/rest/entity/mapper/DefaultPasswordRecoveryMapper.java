...
public class DefaultPasswordRecoveryMapper implements PasswordRecoveryMapper {

  @Override
  public PasswordRecovery toPasswordRecovery(PasswordRecoveryData passwordRecovery) {
    return new PasswordRecovery(passwordRecovery.getPassword(), passwordRecovery.getUuid());

  }

  @Override
  public LoginOrEmail toLoginOrEmail(LoginOrEmailData loginOrEmail) {
    return new LoginOrEmail(loginOrEmail.getLoginOrEmail());
  }
